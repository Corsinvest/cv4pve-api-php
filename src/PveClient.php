...
namespace Corsinvest\ProxmoxVE\Api {
    ...
    class PVEClusterMetrics
    {
         ...
         * @return PVEMetricsClusterExport
         */
        public function getExport()
        {
            return $this->export ?: ($this->export = new PVEMetricsClusterExport($this->client));
        }
    ...
    class PVEItemServerMetricsClusterId
    {
         ...
         * @param int $otel_max_body_size Maximum request body size in bytes
         ...
         * @param int $otel_timeout HTTP request timeout in seconds
         * @param bool $otel_verify_ssl Verify SSL certificates
        ...
        public function create($port, $server, $type, $api_path_prefix = null, $bucket = null, $disable = null, $influxdbproto = null, $max_body_size = null, $mtu = null, $organization = null, $otel_compression = null, $otel_headers = null, $otel_max_body_size = null, $otel_path = null, $otel_protocol = null, $otel_resource_attributes = null, $otel_timeout = null, $otel_verify_ssl = null, $path = null, $proto = null, $timeout = null, $token = null, $verify_certificate = null)
        {
            $params = [
                'port' => $port,
                'server' => $server,
        ...
        public function update($port, $server, $api_path_prefix = null, $bucket = null, $delete = null, $digest = null, $disable = null, $influxdbproto = null, $max_body_size = null, $mtu = null, $organization = null, $otel_compression = null, $otel_headers = null, $otel_max_body_size = null, $otel_path = null, $otel_protocol = null, $otel_resource_attributes = null, $otel_timeout = null, $otel_verify_ssl = null, $path = null, $proto = null, $timeout = null, $token = null, $verify_certificate = null)
        {
            $params = [
                'port' => $port,
                'server' => $server,
    ...
    class PVEClusterNotifications
    {
         ...
         * @ignore
         */
        private $matcherFields;
        /**
         * Get NotificationsClusterMatcherFields
         * @return PVENotificationsClusterMatcherFields
         */
        public function getMatcherFields()
        {
            return $this->matcherFields ?: ($this->matcherFields = new PVENotificationsClusterMatcherFields($this->client));
        }
        /**
         * @ignore
         */
        private $matcherFieldValues;
        /**
         * Get NotificationsClusterMatcherFieldValues
         * @return PVENotificationsClusterMatcherFieldValues
         */
        public function getMatcherFieldValues()
        {
            return $this->matcherFieldValues ?: ($this->matcherFieldValues = new PVENotificationsClusterMatcherFieldValues($this->client));
        }
        /**
         * @ignore
         */
    ...
    class PVENotificationsClusterMatcherFields
    {
        ...
        public function getMatcherFields()
        {
            return $this->client->get("/cluster/notifications/matcher-fields");
        }
    }
    ...
    class PVENotificationsClusterMatcherFieldValues
    {
        ...
        public function getMatcherFieldValues()
        {
            return $this->client->get("/cluster/notifications/matcher-field-values");
        }
    }
    ...
    class PVENotificationsClusterEndpoints
    {
         ...
         * @return PVEEndpointsNotificationsClusterWebhook
         */
        public function getWebhook()
        {
            return $this->webhook ?: ($this->webhook = new PVEEndpointsNotificationsClusterWebhook($this->client));
        }
    ...
    class PVEEndpointsNotificationsClusterWebhook
    {
         ...
         * @param name
         * @return PVEItemWebhookEndpointsNotificationsClusterName
         */
        public function get($name)
        {
        ...
        {
            return $this->client->get("/cluster/notifications/endpoints/webhook");
        }
        /**
        ...
        public function createWebhookEndpoint($method, $name, $url, $body = null, $comment = null, $disable = null, $header = null, $secret = null)
        {
            $params = [
                'method' => $method,
                'name' => $name,
            ...
            return $this->client->create("/cluster/notifications/endpoints/webhook", $params);
        }
    }
    /**
    ...
    class PVEItemWebhookEndpointsNotificationsClusterName
    {
        ...
        {
            return $this->client->delete("/cluster/notifications/endpoints/webhook/{$this->name}");
        }
        /**
        ...
        {
            return $this->client->get("/cluster/notifications/endpoints/webhook/{$this->name}");
        }
        /**
        ...
        public function updateWebhookEndpoint($body = null, $comment = null, $delete = null, $digest = null, $disable = null, $header = null, $method = null, $secret = null, $url = null)
        {
            $params = [
                'body' => $body,
                'comment' => $comment,
            ...
            return $this->client->set("/cluster/notifications/endpoints/webhook/{$this->name}", $params);
        }
    }
    ...
    class PVEItemGroupGroupsFirewallClusterPos
    {
         ...
         * @ignore
         */
        public function __construct($client, $group, $pos)
        {
            $this->client = $client;
            $this->group = $group;
            $this->pos = $pos;
    ...
    class PVEItemRulesFirewallClusterPos
    {
         ...
         * @ignore
         */
        public function __construct($client, $pos)
        {
            $this->client = $client;
            $this->pos = $pos;
        }
    ...
    class PVEItemNameIpsetFirewallClusterCidr
    {
         ...
         * @ignore
         */
        public function __construct($client, $name, $cidr)
        {
            $this->client = $client;
            $this->name = $name;
            $this->cidr = $cidr;
    ...
    class PVEFirewallClusterOptions
    {
        ...
        public function setOptions($delete = null, $digest = null, $ebtables = null, $enable = null, $log_ratelimit = null, $policy_forward = null, $policy_in = null, $policy_out = null)
        {
            $params = [
                'delete' => $delete,
                'digest' => $digest,
    ...
    class PVEClusterHa
    {
        ...
        /**
         * Get HaClusterRules
         * @return PVEHaClusterRules
         */
        public function getRules()
        {
            return $this->rules ?: ($this->rules = new PVEHaClusterRules($this->client));
        }
        /**
         * @ignore
         */
    ...
    class PVEHaClusterRules
    {
         ...
         * @param rule
         * @return PVEItemRulesHaClusterRule
         */
        ...
        public function index($resource = null, $type = null)
        {
            $params = [
                'resource' => $resource,
                'type' => $type
            ];
            return $this->client->get("/cluster/ha/rules", $params);
        }
        /**
         * Create HA rule.
         ...
         * @param string $nodes List of cluster node names with optional priority.
         * @param bool $strict Describes whether the node affinity rule is strict or non-strict.
         * @return Result
         */
        ...
        public function createRule($resources, $rule, $type, $affinity = null, $comment = null, $disable = null, $nodes = null, $strict = null)
        {
            ...
            return $this->client->create("/cluster/ha/rules", $params);
        }
    }
    /**
    ...
    class PVEItemRulesHaClusterRule
    {
         ...
         * @ignore
         */
        public function __construct($client, $rule)
        {
            $this->client = $client;
            $this->rule = $rule;
        }
        ...
        {
            return $this->client->delete("/cluster/ha/rules/{$this->rule}");
        }
        /**
         * Read HA rule.
         * @return Result
        ...
        {
            return $this->client->get("/cluster/ha/rules/{$this->rule}");
        }
        /**
         * Update HA rule.
         * @param string $type HA rule type.
        ...
        public function updateRule($type, $affinity = null, $comment = null, $delete = null, $digest = null, $disable = null, $nodes = null, $resources = null, $strict = null)
        {
            ...
            return $this->client->set("/cluster/ha/rules/{$this->rule}", $params);
        }
    }
    ...
    class PVEItemFlagsCephClusterFlag
    {
         ...
         * @ignore
         */
        public function __construct($client, $flag)
        {
            $this->client = $client;
            $this->flag = $flag;
        }
    ...
    class PVEClusterMapping
    {
         ...
         * @return PVEMappingClusterDir
         */
        public function getDir()
        {
            return $this->dir ?: ($this->dir = new PVEMappingClusterDir($this->client));
        }
        /**
         * @ignore
         */
    ...
    class PVEMappingClusterDir
    {
         ...
         * @param id
         * @return PVEItemDirMappingClusterId
         */
        public function get($id)
        {
        ...
        public function index($check_node = null)
        {
            ...
            return $this->client->get("/cluster/mapping/dir", $params);
        }
        /**
        ...
        public function create($id, $map, $description = null)
        {
            ...
            return $this->client->create("/cluster/mapping/dir", $params);
        }
    }
    /**
    ...
    class PVEItemDirMappingClusterId
    {
        ...
        public function delete()
        {
            return $this->client->delete("/cluster/mapping/dir/{$this->id}");
        }
        /**
        ...
        public function get()
        {
            return $this->client->get("/cluster/mapping/dir/{$this->id}");
        }
        /**
        ...
        public function update($delete = null, $description = null, $digest = null, $map = null)
        {
            $params = [
                'delete' => $delete,
                'description' => $description,
            ...
            return $this->client->set("/cluster/mapping/dir/{$this->id}", $params);
        }
    }
    ...
    class PVEMappingClusterPci
    {
         ...
         * @param bool $live_migration_capable Marks the device(s) as being able to be live-migrated (Experimental). This needs hardware and driver support to work.
         * @param bool $mdev Marks the device(s) as being capable of providing mediated devices.
         * @return Result
         */

        public function create($id, $map, $description = null, $live_migration_capable = null, $mdev = null)
        {
            $params = [
                'id' => $id,
                'map' => $map,
    ...
    class PVEItemPciMappingClusterId
    {
        ...
        public function update($delete = null, $description = null, $digest = null, $live_migration_capable = null, $map = null, $mdev = null)
        {
            $params = [
                'delete' => $delete,
                'description' => $description,
    ...
    class PVEClusterSdn
    {
         ...
         * @return PVESdnClusterFabrics
         */
        public function getFabrics()
        {
            return $this->fabrics ?: ($this->fabrics = new PVESdnClusterFabrics($this->client));
        }
        /**
         * @ignore
         */
        ...
        /**
         * Get SdnClusterLock
         * @return PVESdnClusterLock
         */
        public function getLock()
        {
            return $this->lock ?: ($this->lock = new PVESdnClusterLock($this->client));
        }
        /**
         * @ignore
         */
        ...
        public function reload($lock_token = null, $release_lock = null)
        {
            $params = [
                'lock-token' => $lock_token,
                'release-lock' => $release_lock
            ];
            return $this->client->set("/cluster/sdn", $params);
        }
    }
    /**
    ...
    class PVESdnClusterVnets
    {
        ...
        public function create($vnet, $zone, $alias = null, $isolate_ports = null, $lock_token = null, $tag = null, $type = null, $vlanaware = null)
        {
            $params = [
                'vnet' => $vnet,
                'zone' => $zone,
    ...
    class PVEItemVnetsSdnClusterVnet
    {
         ...
         * @ignore
         */
        public function __construct($client, $vnet)
        {
            $this->client = $client;
            $this->vnet = $vnet;
        }
         ...
         * @return PVEVnetVnetsSdnClusterFirewall
         */
        public function getFirewall()
        {
            return $this->firewall ?: ($this->firewall = new PVEVnetVnetsSdnClusterFirewall($this->client, $this->vnet));
        }
        /**
         * @ignore
         */
        ...
        public function delete($lock_token = null)
        {
            $params = ['lock-token' => $lock_token];
            return $this->client->delete("/cluster/sdn/vnets/{$this->vnet}", $params);
        }
        /**
        ...
        public function update($alias = null, $delete = null, $digest = null, $isolate_ports = null, $lock_token = null, $tag = null, $vlanaware = null, $zone = null)
        {
            $params = [
                'alias' => $alias,
                'delete' => $delete,
    ...
    class PVEVnetVnetsSdnClusterFirewall
    {
         ...
         * @return PVEFirewallVnetVnetsSdnClusterRules
         */
        public function getRules()
        {
            return $this->rules ?: ($this->rules = new PVEFirewallVnetVnetsSdnClusterRules($this->client, $this->vnet));
        }
        /**
         * @ignore
         */
         ...
         * @return PVEFirewallVnetVnetsSdnClusterOptions
         */
        public function getOptions()
        {
            return $this->options ?: ($this->options = new PVEFirewallVnetVnetsSdnClusterOptions($this->client, $this->vnet));
        }
        ...
        public function index()
        {
            return $this->client->get("/cluster/sdn/vnets/{$this->vnet}/firewall");
        }
    }
    /**
    ...
    class PVEFirewallVnetVnetsSdnClusterRules
    {
         ...
         * @param pos
         * @return PVEItemRulesFirewallVnetVnetsSdnClusterPos
         */
        public function get($pos)
        {
        ...
        public function getRules()
        {
            return $this->client->get("/cluster/sdn/vnets/{$this->vnet}/firewall/rules");
        }
        /**
         * Create new rule.
         * @param string $action Rule action ('ACCEPT', 'DROP', 'REJECT') or security group name.
        ...
        public function createRule($action, $type, $comment = null, $dest = null, $digest = null, $dport = null, $enable = null, $icmp_type = null, $iface = null, $log = null, $macro = null, $pos = null, $proto = null, $source = null, $sport = null)
        {
            ...
            return $this->client->create("/cluster/sdn/vnets/{$this->vnet}/firewall/rules", $params);
        }
    }
    /**
    ...
    class PVEItemRulesFirewallVnetVnetsSdnClusterPos
    {
         ...
         * @ignore
         */
        public function __construct($client, $vnet, $pos)
        {
            $this->client = $client;
            $this->vnet = $vnet;
            $this->pos = $pos;
        ...
        {
            $params = ['digest' => $digest];
            return $this->client->delete("/cluster/sdn/vnets/{$this->vnet}/firewall/rules/{$this->pos}", $params);
        }
        /**
         * Get single rule data.
         * @return Result
        ...
        public function getRule()
        {
            return $this->client->get("/cluster/sdn/vnets/{$this->vnet}/firewall/rules/{$this->pos}");
        }
        /**
         * Modify rule data.
         * @param string $action Rule action ('ACCEPT', 'DROP', 'REJECT') or security group name.
        ...
        public function updateRule($action = null, $comment = null, $delete = null, $dest = null, $digest = null, $dport = null, $enable = null, $icmp_type = null, $iface = null, $log = null, $macro = null, $moveto = null, $proto = null, $source = null, $sport = null, $type = null)
        {
            ...
            return $this->client->set("/cluster/sdn/vnets/{$this->vnet}/firewall/rules/{$this->pos}", $params);
        }
    }
    ...
    class PVEFirewallVnetVnetsSdnClusterOptions
    {
        ...
        public function getOptions()
        {
            return $this->client->get("/cluster/sdn/vnets/{$this->vnet}/firewall/options");
        }
        /**
         * Set Firewall options.
         * @param string $delete A list of settings you want to delete.
        ...
        public function setOptions($delete = null, $digest = null, $enable = null, $log_level_forward = null, $policy_forward = null)
        {
            $params = [
                'delete' => $delete,
                'digest' => $digest,
            ...
            return $this->client->set("/cluster/sdn/vnets/{$this->vnet}/firewall/options", $params);
        }
    }
    ...
    class PVEVnetVnetsSdnClusterSubnets
    {
        ...
        public function create($subnet, $type, $dhcp_dns_server = null, $dhcp_range = null, $dnszoneprefix = null, $gateway = null, $lock_token = null, $snat = null)
        {
            $params = [
                'subnet' => $subnet,
                'type' => $type,
    ...
    class PVEItemSubnetsVnetVnetsSdnClusterSubnet
    {
         ...
         * @ignore
         */
        public function __construct($client, $vnet, $subnet)
        {
            $this->client = $client;
            $this->vnet = $vnet;
            $this->subnet = $subnet;
        ...
        {
            $params = ['lock-token' => $lock_token];
            return $this->client->delete("/cluster/sdn/vnets/{$this->vnet}/subnets/{$this->subnet}", $params);
        }
        /**
        ...
        public function update($delete = null, $dhcp_dns_server = null, $dhcp_range = null, $digest = null, $dnszoneprefix = null, $gateway = null, $lock_token = null, $snat = null)
        {
            $params = [
                'delete' => $delete,
                'dhcp-dns-server' => $dhcp_dns_server,
    ...
    class PVEItemZonesSdnClusterZone
    {
        ...
        {
            $params = ['lock-token' => $lock_token];
            return $this->client->delete("/cluster/sdn/zones/{$this->zone}", $params);
        }
        /**
    ...
    class PVEItemControllersSdnClusterController
    {
        ...
        {
            $params = ['lock-token' => $lock_token];
            return $this->client->delete("/cluster/sdn/controllers/{$this->controller}", $params);
        }
        /**
    ...
    class PVESdnClusterIpams
    {
        ...
        public function create($ipam, $type, $fingerprint = null, $lock_token = null, $section = null, $token = null, $url = null)
        {
            $params = [
                'ipam' => $ipam,
                'type' => $type,
    ...
    class PVEItemIpamsSdnClusterIpam
    {
         ...
         * @ignore
         */
        public function __construct($client, $ipam)
        {
            $this->client = $client;
            $this->ipam = $ipam;
        }
        ...
        {
            $params = ['lock-token' => $lock_token];
            return $this->client->delete("/cluster/sdn/ipams/{$this->ipam}", $params);
        }
        /**
        ...
        public function update($delete = null, $digest = null, $fingerprint = null, $lock_token = null, $section = null, $token = null, $url = null)
        {
            $params = [
                'delete' => $delete,
                'digest' => $digest,
    ...
    class PVESdnClusterDns
    {
        ...
        public function create($dns, $key, $type, $url, $fingerprint = null, $lock_token = null, $reversemaskv6 = null, $reversev6mask = null, $ttl = null)
        {
            $params = [
                'dns' => $dns,
                'key' => $key,
    ...
    class PVEItemDnsSdnClusterDns
    {
         ...
         * @ignore
         */
        public function __construct($client, $dns)
        {
            $this->client = $client;
            $this->dns = $dns;
        }
        ...
        {
            $params = ['lock-token' => $lock_token];
            return $this->client->delete("/cluster/sdn/dns/{$this->dns}", $params);
        }
        /**
        ...
        public function update($delete = null, $digest = null, $fingerprint = null, $key = null, $lock_token = null, $reversemaskv6 = null, $ttl = null, $url = null)
        {
            $params = [
                'delete' => $delete,
                'digest' => $digest,
    ...
    class PVESdnClusterFabrics
    {
         ...
         * @return PVEFabricsSdnClusterFabric
         */
        public function getFabric()
        {
            return $this->fabric ?: ($this->fabric = new PVEFabricsSdnClusterFabric($this->client));
        }
        /**
         * @ignore
         */
         ...
         * @return PVEFabricsSdnClusterNode
         */
        public function getNode()
        {
            return $this->node ?: ($this->node = new PVEFabricsSdnClusterNode($this->client));
        }
        /**
         * @ignore
         */
         ...
         * @return PVEFabricsSdnClusterAll
         */
        public function getAll()
        {
            return $this->all ?: ($this->all = new PVEFabricsSdnClusterAll($this->client));
        }
        ...
        public function index()
        {
            return $this->client->get("/cluster/sdn/fabrics");
        }
    }
    /**
    ...
    class PVEFabricsSdnClusterFabric
    {
         ...
         * @param id
         * @return PVEItemFabricFabricsSdnClusterId
         */
        public function get($id)
        {
        ...
        public function index($pending = null, $running = null)
        {
            ...
            return $this->client->get("/cluster/sdn/fabrics/fabric", $params);
        }
        /**
         * Add a fabric
         ...
         * @param string $digest Prevent changes if current configuration file has a different digest. This can be used to prevent concurrent modifications.
         * @param float $hello_interval The hello_interval property for Openfabric
    ...
    class PVEItemFabricFabricsSdnClusterId
    {
        ...
        {
            return $this->client->delete("/cluster/sdn/fabrics/fabric/{$this->id}");
        }
        /**
         * Update a fabric
         * @return Result
        ...
        public function getFabric()
        {
            return $this->client->get("/cluster/sdn/fabrics/fabric/{$this->id}");
        }
        /**
         * Update a fabric
         * @param array $delete 
    ...
    class PVEFabricsSdnClusterNode
    {
         ...
         * @param fabric_id
         * @return PVEItemNodeFabricsSdnClusterFabricId
         */
        public function get($fabric_id)
        {
        ...
        public function listNodes($pending = null, $running = null)
        {
            $params = [
                'pending' => $pending,
                'running' => $running
            ];
            return $this->client->get("/cluster/sdn/fabrics/node", $params);
        }
    }
    /**
    ...
    class PVEItemNodeFabricsSdnClusterFabricId
    {
         ...
         * @ignore
         */
        public function __construct($client, $fabric_id)
        {
            $this->client = $client;
         ...
         * @param node_id
         * @return PVEItemFabricIdNodeFabricsSdnClusterNodeId
         */
        ...
        public function listNodesFabric($pending = null, $running = null)
        {
            $params = [
                'pending' => $pending,
                'running' => $running
            ];
            return $this->client->get("/cluster/sdn/fabrics/node/{$this->fabric_id}", $params);
        }
        /**
         * Add a node
    ...
    class PVEItemFabricIdNodeFabricsSdnClusterNodeId
    {
         ...
         * @ignore
         */
        public function __construct($client, $fabric_id, $node_id)
        {
            $this->client = $client;
            $this->fabric_id = $fabric_id;
        ...
        {
            return $this->client->delete("/cluster/sdn/fabrics/node/{$this->fabric_id}/{$this->node_id}");
        }
        /**
         * Get a node
         * @return Result
        ...
        public function getNode()
        {
            return $this->client->get("/cluster/sdn/fabrics/node/{$this->fabric_id}/{$this->node_id}");
        }
        /**
         * Update a node
         * @param array $interfaces 
    ...
    class PVEFabricsSdnClusterAll
    {
        ...
        public function listAll($pending = null, $running = null)
        {
            $params = [
                'pending' => $pending,
                'running' => $running
    ...
    class PVESdnClusterLock
    {
         ...
         * @param bool $force if true, allow releasing lock without providing the token
         * @param string $lock_token the token for unlocking the global SDN configuration
         * @return Result
         */

        public function releaseLock($force = null, $lock_token = null)
        {
            $params = [
                'force' => $force,
                'lock-token' => $lock_token
            ];
            return $this->client->delete("/cluster/sdn/lock", $params);
        }
        /**
         * Acquire global lock for SDN configuration
         * @param bool $allow_pending if true, allow acquiring lock even though there are pending changes
         * @return Result
         */

        public function lock($allow_pending = null)
        {
            $params = ['allow-pending' => $allow_pending];
            return $this->client->create("/cluster/sdn/lock", $params);
        }
    }
    ...
    class PVESdnClusterRollback
    {
         ...
         * @param string $lock_token the token for unlocking the global SDN configuration
         * @param bool $release_lock When lock-token has been provided and configuration successfully rollbacked, release the lock automatically afterwards
         * @return Result
         */

        public function rollback($lock_token = null, $release_lock = null)
        {
            $params = [
                'lock-token' => $lock_token,
                'release-lock' => $release_lock
    ...
    class PVENodeNodesQemu
    {
         ...
         * @param bool $live_restore Start the VM immediately while importing or restoring in the background.
        ...
        public function createVm($vmid, $acpi = null, $affinity = null, $agent = null, $allow_ksm = null, $amd_sev = null, $arch = null, $archive = null, $args = null, $audio0 = null, $autostart = null, $balloon = null, $bios = null, $boot = null, $bootdisk = null, $bwlimit = null, $cdrom = null, $cicustom = null, $cipassword = null, $citype = null, $ciupgrade = null, $ciuser = null, $cores = null, $cpu = null, $cpulimit = null, $cpuunits = null, $description = null, $efidisk0 = null, $force = null, $freeze = null, $ha_managed = null, $hookscript = null, $hostpciN = null, $hotplug = null, $hugepages = null, $ideN = null, $import_working_storage = null, $intel_tdx = null, $ipconfigN = null, $ivshmem = null, $keephugepages = null, $keyboard = null, $kvm = null, $live_restore = null, $localtime = null, $lock = null, $machine = null, $memory = null, $migrate_downtime = null, $migrate_speed = null, $name = null, $nameserver = null, $netN = null, $numa = null, $numaN = null, $onboot = null, $ostype = null, $parallelN = null, $pool = null, $protection = null, $reboot = null, $rng0 = null, $sataN = null, $scsiN = null, $scsihw = null, $searchdomain = null, $serialN = null, $shares = null, $smbios1 = null, $smp = null, $sockets = null, $spice_enhancements = null, $sshkeys = null, $start = null, $startdate = null, $startup = null, $storage = null, $tablet = null, $tags = null, $tdf = null, $template = null, $tpmstate0 = null, $unique = null, $unusedN = null, $usbN = null, $vcpus = null, $vga = null, $virtioN = null, $virtiofsN = null, $vmgenid = null, $vmstatestorage = null, $watchdog = null)
        {
            ...
            $this->client->addIndexedParameter($params, 'virtiofs', $virtiofsN);
    ...
    class PVEItemQemuNodeNodesVmid
    {
         ...
         * @ignore
         */
        public function __construct($client, $node, $vmid)
        {
            $this->client = $client;
            $this->node = $node;
            $this->vmid = $vmid;
         ...
         * @return PVEVmidQemuNodeNodesDbusVmstate
         */
        public function getDbusVmstate()
        {
            return $this->dbusVmstate ?: ($this->dbusVmstate = new PVEVmidQemuNodeNodesDbusVmstate($this->client, $this->node, $this->vmid));
        }
    ...
    class PVEItemRulesFirewallVmidQemuNodeNodesPos
    {
         ...
         * @ignore
         */
        public function __construct($client, $node, $vmid, $pos)
        {
            $this->client = $client;
            $this->node = $node;
            $this->vmid = $vmid;
    ...
    class PVEItemAliasesFirewallVmidQemuNodeNodesName
    {
         ...
         * @ignore
         */
        public function __construct($client, $node, $vmid, $name)
        {
            $this->client = $client;
            $this->node = $node;
            $this->vmid = $vmid;
    ...
    class PVEItemNameIpsetFirewallVmidQemuNodeNodesCidr
    {
         ...
         * @ignore
         */
        public function __construct($client, $node, $vmid, $name, $cidr)
        {
            $this->client = $client;
            $this->node = $node;
            $this->vmid = $vmid;
    ...
    class PVEStatusVmidQemuNodeNodesStart
    {
         ...
         * @param bool $with_conntrack_state Whether to migrate conntrack entries for running VMs.
         * @return Result
         */
    ...
    class PVEStatusVmidQemuNodeNodesStop
    {
         ...
         * @param string $migratedfrom The cluster node name.
         * @param bool $overrule_shutdown Try to abort active 'qmshutdown' tasks before stopping.
         * @param bool $skiplock Ignore locks - only root is allowed to use this option.
         * @param int $timeout Wait maximal timeout seconds.
         * @return Result
         */

        public function vmStop($keepActive = null, $migratedfrom = null, $overrule_shutdown = null, $skiplock = null, $timeout = null)
        {
            $params = [
    ...
    class PVEVmidQemuNodeNodesMigrate
    {
        ...
        public function migrateVm($target, $bwlimit = null, $force = null, $migration_network = null, $migration_type = null, $online = null, $targetstorage = null, $with_conntrack_state = null, $with_local_disks = null)
        {
            $params = [
                'target' => $target,
                'bwlimit' => $bwlimit,
    ...
    class PVEVmidQemuNodeNodesRemoteMigrate
    {
         ...
         * @param int $bwlimit Override I/O bandwidth limit (in KiB/s).
         * @param bool $delete Delete the original VM and related data after successful migration. By default the original VM is kept on the source cluster in a stopped state.
         * @param bool $online Use online/live migration if VM is running. Ignored if VM is stopped.
         * @param int $target_vmid The (unique) ID of the VM.
         * @return Result
         */
    ...
    class PVEItemSnapshotVmidQemuNodeNodesSnapname
    {
         ...
         * @ignore
         */
        public function __construct($client, $node, $vmid, $snapname)
        {
            $this->client = $client;
            $this->node = $node;
            $this->vmid = $vmid;
    ...
    class PVEVmidQemuNodeNodesDbusVmstate
    {
        ...
        public function dbusVmstate($action)
        {
            $params = ['action' => $action];
            return $this->client->create("/nodes/{$this->node}/qemu/{$this->vmid}/dbus-vmstate", $params);
        }
    }
    ...
    class PVEStatusVmidLxcNodeNodesStop
    {
         ...
         * @param bool $overrule_shutdown Try to abort active 'vzshutdown' tasks before stopping.
         * @param bool $skiplock Ignore locks - only root is allowed to use this option.
         * @return Result
         */

        public function vmStop($overrule_shutdown = null, $skiplock = null)
        {
            $params = [
                'overrule-shutdown' => $overrule_shutdown,
                'skiplock' => $skiplock
    ...
    class PVEVmidLxcNodeNodesRemoteMigrate
    {
         ...
         * @param string $target_storage Mapping from source to target storages. Providing only a single storage ID maps all source storages to that storage. Providing the special value '1' will map each source storage to itself.
         * @param float $bwlimit Override I/O bandwidth limit (in KiB/s).
         * @param bool $delete Delete the original CT and related data after successful migration. By default the original CT is kept on the source cluster in a stopped state.
    ...
    class PVEVmidLxcNodeNodesMigrate
    {
        ...
        {
            $params = ['target' => $target];
            return $this->client->get("/nodes/{$this->node}/lxc/{$this->vmid}/migrate", $params);
        }
        /**
    ...
    class PVEItemOsdCephNodeNodesOsdid
    {
         ...
         * @ignore
         */
        public function __construct($client, $node, $osdid)
        {
            $this->client = $client;
            $this->node = $node;
            $this->osdid = $osdid;
    ...
    class PVEItemMdsCephNodeNodesName
    {
         ...
         * @ignore
         */
        public function __construct($client, $node, $name)
        {
            $this->client = $client;
            $this->node = $node;
            $this->name = $name;
    ...
    class PVEItemMgrCephNodeNodesId
    {
         ...
         * @ignore
         */
        public function __construct($client, $node, $id)
        {
            $this->client = $client;
            $this->node = $node;
            $this->id = $id;
    ...
    class PVEItemMonCephNodeNodesMonid
    {
         ...
         * @ignore
         */
        public function __construct($client, $node, $monid)
        {
            $this->client = $client;
            $this->node = $node;
            $this->monid = $monid;
    ...
    class PVEItemServicesNodeNodesService
    {
         ...
         * @ignore
         */
        public function __construct($client, $node, $service)
        {
            $this->client = $client;
            $this->node = $node;
    ...
    class PVENodeNodesNetwork
    {
         ...
         * @param bool $regenerate_frr Whether FRR config generation should get skipped or not.
         * @return Result
         */

        public function reloadNetworkConfig($regenerate_frr = null)
        {
            $params = ['regenerate-frr' => $regenerate_frr];
            return $this->client->set("/nodes/{$this->node}/network", $params);
        }
    }
    /**
    ...
    class PVEItemNetworkNodeNodesIface
    {
         ...
         * @ignore
         */
        public function __construct($client, $node, $iface)
        {
            $this->client = $client;
            $this->node = $node;
            $this->iface = $iface;
        ...
        public function updateNetwork($type, $address = null, $address6 = null, $autostart = null, $bond_primary = null, $bond_mode = null, $bond_xmit_hash_policy = null, $bridge_ports = null, $bridge_vids = null, $bridge_vlan_aware = null, $cidr = null, $cidr6 = null, $comments = null, $comments6 = null, $delete = null, $gateway = null, $gateway6 = null, $mtu = null, $netmask = null, $netmask6 = null, $ovs_bonds = null, $ovs_bridge = null, $ovs_options = null, $ovs_ports = null, $ovs_tag = null, $slaves = null, $vlan_id = null, $vlan_raw_device = null)
        {
            $params = [
                'type' => $type,
                'address' => $address,
    ...
    class PVEItemTasksNodeNodesUpid
    {
         ...
         * @ignore
         */
        public function __construct($client, $node, $upid)
        {
            $this->client = $client;
            $this->node = $node;
            $this->upid = $upid;
    ...
    class PVEHardwareNodeNodesPci
    {
         ...
         * @return PVEItemPciHardwareNodeNodesPciIdOrMapping
         */
        public function get($pci_id_or_mapping)
        {
            return new PVEItemPciHardwareNodeNodesPciIdOrMapping($this->client, $this->node, $pci_id_or_mapping);
        }
    ...
    class PVEItemPciHardwareNodeNodesPciIdOrMapping
    {
         ...
         * @ignore
         */
        public function __construct($client, $node, $pci_id_or_mapping)
        {
            $this->client = $client;
            $this->node = $node;
         ...
         * @return PVEPciIdOrMappingPciHardwareNodeNodesMdev
         */
        public function getMdev()
        {
            return $this->mdev ?: ($this->mdev = new PVEPciIdOrMappingPciHardwareNodeNodesMdev($this->client, $this->node, $this->pci_id_or_mapping));
        }
    ...
    class PVECapabilitiesNodeNodesQemu
    {
         ...
         * @return PVEQemuCapabilitiesNodeNodesMigration
         */
        public function getMigration()
        {
            return $this->migration ?: ($this->migration = new PVEQemuCapabilitiesNodeNodesMigration($this->client, $this->node));
        }
    ...
    class PVEQemuCapabilitiesNodeNodesMigration
    {
        ...
        {
            return $this->client->get("/nodes/{$this->node}/capabilities/qemu/migration");
        }
    }
    ...
    class PVEItemStorageNodeNodesStorage
    {
         ...
         * @return PVEStorageStorageNodeNodesImportMetadata
         */
    ...
    class PVEItemContentStorageStorageNodeNodesVolume
    {
         ...
         * @ignore
         */
        public function __construct($client, $node, $storage, $volume)
        {
            $this->client = $client;
            $this->node = $node;
            $this->storage = $storage;
    ...
    class PVEStorageStorageNodeNodesImportMetadata
    {
        ...
        public function getImportMetadata($volume)
        {
            $params = ['volume' => $volume];
    ...
    class PVEItemRulesFirewallNodeNodesPos
    {
         ...
         * @ignore
         */
        public function __construct($client, $node, $pos)
        {
            $this->client = $client;
            $this->node = $node;
            $this->pos = $pos;
    ...
    class PVEFirewallNodeNodesOptions
    {
         ...
         * @param bool $nftables Enable nftables based firewall (tech preview)
        ...
        public function setOptions($delete = null, $digest = null, $enable = null, $log_level_forward = null, $log_level_in = null, $log_level_out = null, $log_nf_conntrack = null, $ndp = null, $nf_conntrack_allow_invalid = null, $nf_conntrack_helpers = null, $nf_conntrack_max = null, $nf_conntrack_tcp_timeout_established = null, $nf_conntrack_tcp_timeout_syn_recv = null, $nftables = null, $nosmurfs = null, $protection_synflood = null, $protection_synflood_burst = null, $protection_synflood_rate = null, $smurf_log_level = null, $tcp_flags_log_level = null, $tcpflags = null)
        {
            $params = [
                'delete' => $delete,
                'digest' => $digest,
    ...
    class PVEStorage
    {
         ...
         * @param bool $skip_cert_verification Disable TLS certificate verification, only enable on fully trusted networks!
    ...
    class PVEItemTokenUseridUsersAccessTokenid
    {
         ...
         * @ignore
         */
        public function __construct($client, $userid, $tokenid)
        {
            $this->client = $client;
            $this->userid = $userid;
    ...
    class PVEItemGroupsAccessGroupid
    {
         ...
         * @ignore
         */
        public function __construct($client, $groupid)
        {
            $this->client = $client;
    ...
    class PVEItemRolesAccessRoleid
    {
         ...
         * @ignore
         */
        public function __construct($client, $roleid)
        {
            $this->client = $client;
            $this->roleid = $roleid;
        }
    ...
    class PVEAccessDomains
    {
         ...
         * @param bool $groups_autocreate Automatically create groups if they do not exist.
         * @param string $groups_claim OpenID claim used to retrieve groups with.
         * @param bool $groups_overwrite All groups will be overwritten for the user on login.
    ...
    class PVEItemDomainsAccessRealm
    {
         ...
         * @ignore
         */
        public function __construct($client, $realm)
        {
            $this->client = $client;
            $this->realm = $realm;
        }
    ...
    class PVEItemUseridTfaAccessId
    {
         ...
         * @ignore
         */
        public function __construct($client, $userid, $id)
        {
            $this->client = $client;
            $this->userid = $userid;
            $this->id = $id;
    ...
    class PVEAccessPassword
    {
        ...
        public function changePassword($password, $userid, $confirmation_password = null)
        {
            $params = [
                'password' => $password,
                'userid' => $userid,
    ...
    class PVEItemPoolsPoolid
    {
         ...
         * @ignore
         */
        public function __construct($client, $poolid)
        {
            $this->client = $client;
            $this->poolid = $poolid;
        }
